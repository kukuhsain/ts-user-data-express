...
describe("API Tests", () => {
  ...
  beforeEach(async () => {
    await request(app).delete("/users/cache");
  ...
  describe("GET /users/:id", () => {
    ...
    it("returns different users for different IDs", async () => {
      const user1 = await request(app).get("/users/1").expect(200);
      const user2 = await request(app).get("/users/2").expect(200);
      const user3 = await request(app).get("/users/3").expect(200);
  ...
  describe("GET /users/cache/stats", () => {
  ...
  describe("GET /users/queue/stats", () => {
  ...
  describe("GET /users/cache-status", () => {
  ...
  describe("DELETE /users/cache", () => {
    ...
    it("resets cache statistics after clearing", async () => {
      ...
      // Clear cache
      await request(app).delete("/users/cache").expect(200);
  ...
  describe("Rate Limiting", () => {
    ...
    it("decrements remaining count with each request", async () => {
      const first = await request(app).get("/users/1").expect(200);
      const second = await request(app).get("/users/1").expect(200);
